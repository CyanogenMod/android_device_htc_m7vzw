...
public class HTCQualcommRIL extends RIL implements CommandsInterface {
    ...
    responseToStringHTC(int request) {
        switch(request) {
            case RIL_UNSOL_ENTER_LPM: return "UNSOL_RIL_UNSOL_ENTER_LPM";
            case RIL_UNSOL_CDMA_3G_INDICATOR: return "UNSOL_UNSOL_CDMA_3G_INDICATOR";
            case RIL_UNSOL_CDMA_ENHANCE_ROAMING_INDICATOR: return "UNSOL_UNSOL_CDMA_ENHANCE_ROAMING_INDICATOR";
